...
CREATE TABLE registrations (
  ...
  uniform_size TEXT,
  program_type TEXT DEFAULT 'BOARDING',
  info_source TEXT,
  reason_to_join TEXT,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
-- Seed Registrations
INSERT INTO registrations (user_id, nisn, nik, birth_place, birth_date, gender, address, father_name, mother_name, parent_phone, previous_school, status, payment_status, payment_proof_url, program_type, info_source, reason_to_join) VALUES
(2, '0051234567', '1371012304050001', 'Pulau Punjung', '2008-05-14', 'L', 'Jorong Ranah Lintas, Dharmasraya', 'Budi Santoso', 'Siti Aminah', '081266778899', 'SMP Negeri 1 Pulau Punjung', 'SUBMITTED', 'PENDING', 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=600&q=80', 'BOARDING', 'Instagram / Facebook Official', 'Ingin fokus mendalami program Tahfidz Al-Qur''an 10 Juz serta pembentukan karakter kepemimpinan Islam.'),
(3, '0059876543', '1371012304050002', 'Sungai Dareh', '2008-08-20', 'P', 'Nagari Tebing Tinggi, Dharmasraya', 'Rahman Hakim', 'Nurhaliza', '081399887766', 'MTsN 1 Dharmasraya', 'DRAFT', 'UNPAID', NULL, 'REGULER', 'Brosur / Leaflet Informasi', 'Kualitas akademis lulusan yang terbukti banyak diterima di PTN favorit.');
...
-- --------------------------------------------------------
-- 12. TABEL: visitor_logs (Pencatatan Kunjungan Website & Lokasi)
-- --------------------------------------------------------
CREATE TABLE visitor_logs (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ip TEXT,
  city TEXT DEFAULT 'Pulau Punjung',
  region TEXT DEFAULT 'Sumatera Barat',
